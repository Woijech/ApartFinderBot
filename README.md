...
APARTMENTFINDER_SOURCE_FETCH_CONCURRENCY=2
APARTMENTFINDER_SUBSCRIPTION_CHECK_CONCURRENCY=3
APARTMENTFINDER_SOURCE_LIMITS__KUFAR__MAX_REQUESTS_PER_MINUTE=60
APARTMENTFINDER_SOURCE_LIMITS__KUFAR__MIN_DELAY=0.5
APARTMENTFINDER_SOURCE_LIMITS__KUFAR__MAX_DELAY=10
APARTMENTFINDER_SOURCE_LIMITS__KUFAR__JITTER=0.2
APARTMENTFINDER_SOURCE_LIMITS__KUFAR__COOLDOWN_AFTER_ERRORS=3
APARTMENTFINDER_SOURCE_LIMITS__KUFAR__BROWSER_FALLBACK_LIMIT=3
APARTMENTFINDER_SOURCE_LIMITS__REALT__MAX_REQUESTS_PER_MINUTE=60
APARTMENTFINDER_SOURCE_LIMITS__REALT__MIN_DELAY=0.5
APARTMENTFINDER_SOURCE_LIMITS__REALT__MAX_DELAY=10
APARTMENTFINDER_SOURCE_LIMITS__REALT__JITTER=0.2
APARTMENTFINDER_SOURCE_LIMITS__REALT__COOLDOWN_AFTER_ERRORS=3
APARTMENTFINDER_SOURCE_LIMITS__REALT__BROWSER_FALLBACK_LIMIT=3
